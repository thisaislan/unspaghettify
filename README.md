...
I could have called this project *"Ways I Found to Improve My Game Workflow"*, or *"Crazy Ideas I Had to Make Games"*, or even *"Let's Talk About Game Development"*. But I think the current name is a little more memorable - and it brings the right feeling. Especially the spaghetti part.
...
I know, nothing new under the sun. But let me at least try to show you the idea behind it all, before you make your final decision: [should I stay, or should I go](https://www.youtube.com/watch?v=xMaE6toi4mk)?

## The Work

The idea is simple: instead of just talking about what to do and how to do it in a game project, we’ll take a simple project and walk it through a path of architectural improvements, coding improvements, and—why not—a bit of fluff. That’s the advantage of being on GitHub.

Every new update will bring details about what changed, why it changed, and some discussion around that.

One important part of this project: I'm still writing it. In other words, we'll discover the best approach and path during development. That also means things will probably change (a lot) over time. But software architecture is a dynamic exploration, so the idea of changing things over time is nothing new.
...
I was born in Salvador, a small, hot, and beautiful city in the northeast of Brazil. In 2017, I graduated with high honors, earning a bachelor’s degree in Computer Science. The following year, I decided to launch my first game with two friends. The goal was simple: put everything I knew to the test. So I wore every hat - software developer, artist, game designer, audio engineer, tool builder, project manager. In 2019, we happily launched [Jump Box](https://play.google.com/store/apps/details?id=com.jumpjump.jumpbox&hl=en-US) on the Google Play Store.

When I'm not studying, working, or playing video games, I make crazy little projects. Small mobile apps, unconventional web experiments, little games in different engines. Just for fun and to keep my knowledge sharp. If you want to see some of my crazy projects, you can find some of them on my [GitHub](https://github.com/thisaislan).
...
> The chapter title was inspired by Bob Nystrom's talk, [Is There More to Game Architecture than ECS?](https://www.youtube.com/watch?v=JxI3Eu5DPwE), just amazing.
...
Also, there are libraries and ideas I want to expose and test myself. I want to feel how they behave during the project's evolution and, in the end, bring my impressions to the table. So, I need to put my own hands on the project and feel things for myself.
...
> If you're curious about what AI tool I am using in this project: [DeepSeek](https://deepseek.com/en/index.html), the free online version. Believe me, you can get a huge amount of help just with free tools these days.
...
- **Z** – Vanity/Fluff: The aesthetic and personal touches. How much frivolous polish (frou-frou) have I added for my own delight?
...
The first tag will be [v0.0.0](https://github.com/thisaislan/unspaghettify/blob/v0.0.0/README.md) - the bare-bones project, the starting point. You can find the full list of available tags and their contents [here](https://github.com/thisaislan/unspaghettify/blob/index/README.md).
...
That way, if you ever want to see where this project thinks is a nice way to work, you can find it easily here.
...
> Oh, and yes — there's more to game projects than managers, singletons, and spaghetti. But to find that out, we need to talk a little more.
